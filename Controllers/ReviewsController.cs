...
namespace KitabPasall.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,BookId,Id,Rating,Comment")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ReviewId,BookId,Id,Rating,Comment")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
